...
// IIFE to sync sliders with input fields on load
(() => {
    invest_range.value = investment.value;
    rate_range.value = rate.value;
    time_range.value = time.value;
    handleChange(); // trigger first calculation and chart
})();
...
// Main handler for updating values and chart
...
// Also update chart on manual input changes (optional but useful)
